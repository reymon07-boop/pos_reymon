...
<style>
    ...
    .custom-table thead th:first-child { border-radius: 11px 0 0 11px; }
    .custom-table thead th:last-child { border-radius: 0 11px 11px 0; }

    .custom-table tbody tr { transition: all 0.2s ease; }
    .custom-table tbody tr:hover { transform: translateY(-1px); }
    ...
    .custom-table tbody tr:hover td { background: rgba(30, 41, 59, 0.95); }
    ...
    @media (max-width: 576px) {
        ...
        .header-box { border-radius: 17px; padding: 20px; }
        .main-card { border-radius: 16px; padding: 14px; }
        .stat-card { padding: 17px; border-radius: 15px; }
        .stat-icon { width: 45px; height: 45px; border-radius: 13px; }
        .stat-value { font-size: 20px; }
        .search-container { padding-left: 12px; }
        .btn-search-submit { padding: 8px 12px; }
    }
</style>
        ...
        <div class="mb-4">
            <form action="{{ route('admin.users') }}" method="GET">
                <div class="search-container">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" class="form-control search-input" placeholder="Cari berdasarkan nama atau email pengguna...">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted" style="font-size: 11px;">Terdaftar ID: #{{ $user->id }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('admin.users.edit', $user) }}" class="btn-act btn-act-edit" title="Edit Pengguna">
                                        ✏️ Edit
                                    </a>
                                    ...
                                    <form action="{{ route('admin.users.destroy', $user) }}" method="POST" class="d-inline m-0">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn-act btn-act-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus user ini?')" title="Hapus Pengguna">
                                            🗑️ Hapus
                                        </button>
                                    </form>
                                </div>
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                <div class="py-3">
                                    ...
                                    <p class="text-muted small mb-0">Klik "+ Tambah User Baru" untuk menambahkan pengguna baru.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
